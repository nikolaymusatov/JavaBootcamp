...
import edu.school21.SocketServer.exceptions.AlreadySignedInException;
...
public class ClientHandler implements Runnable {
    ...
    public ClientHandler(Socket socket, Server server, UsersService usersService,
            ...
            do {
                ...
                if (message.equalsIgnoreCase("signUp")) {
                    ...
                    if (currentUser == null) {
                        ...
                        this.server.broadcastMessage(newMessage);
                    }
                }
