...
public class ProductRepositoryJdbcImplTest {
    ...
    public void init() {
        db = new EmbeddedDatabaseBuilder()
                ...
                .addScript("data.sql")
                .build();
        this.pr = new ProductRepositoryJdbcImpl(db);
    }
    
    @Test
    public void checkFindAll() {
        assertEquals(this.pr.findAll(), EXPECTED_FIND_ALL_PRODUCTS);
    }
    
    @Test
    public void checkFindById() {
        assertEquals(this.pr.findById(2L).orElse(null),
    ...
    public void checkUpdate() {
        ...
        assertEquals(this.pr.findById(5L).orElse(null),
    ...
    public void checkSave() {
        ...
        assertEquals(this.pr.findById(6L).orElse(null), EXPECTED_SAVED_PRODUCT);
    }

    @Test
    public void checkDelete() {
        pr.delete(3L);
        assertNull(this.pr.findById(3L).orElse(null));
    }
